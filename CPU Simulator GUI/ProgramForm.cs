    ...
    public partial class ProgramForm : Form
    {
        public ProgramForm()
        {
           ...
           /* if (mn==4)
            {
                ...
                //Table.Columns.Add("Ending Time(s)", typeof(string));
            }
            else
            {
                Table.Columns.Add("Process Name", typeof(string));
           ...
           */
            ...
            /*if (mn == 1)
            {
                fcfsBtn.Visible = true;
                sjfBtn.Visible = false;
                psBtn.Visible = false;
                rrBtn.Visible = false;
            }*/
            fcfsBtn.Visible = false;
            sjfBtn.Visible = false;
            psBtn.Visible = false;
            rrBtn.Visible = false;
            timeQuantumBox.Visible = false;
        ...
        private void timeQuantumBox_ValueChanged(object sender, EventArgs e)
        {

        }

        private void sjfPreemtiveCheck_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void psPreemtiveCheck_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void ProgramForm_Load(object sender, EventArgs e)
        {
            ...
            if(mn==1)
            {
                label13.Text = "FIRST COME FIRST SERVE";
                fcfsBtn.Visible = true;
                sjfBtn.Visible = false;
                psBtn.Visible = false;
                rrBtn.Visible = false;
            ...
            if(mn==2)
            {
                label13.Text = "SHORTEST JOB FIRST";
                fcfsBtn.Visible = false;
                sjfBtn.Visible = true;
                sjfPreemtiveCheck.Visible = true;
                psBtn.Visible = false;
                rrBtn.Visible = false;
                Table.Columns.Add("Process Name", typeof(string));
                Table.Columns.Add("Arrival Time", typeof(int));
            ...
            if (mn == 3)
            {
                label13.Text = "PRIORITY SCHEDULING";
                fcfsBtn.Visible = false;
                sjfBtn.Visible = false;
                sjfPreemtiveCheck.Visible = false;
                psBtn.Visible = true;
                psPreemtiveCheck.Visible = true;
                rrBtn.Visible = false;
                Table.Columns.Add("Process Name", typeof(string));
                Table.Columns.Add("Arrival Time", typeof(int));
                Table.Columns.Add("Burst Time", typeof(int));
            ...
            if (mn == 4)
            {
                label13.Text = "ROUND ROBBIN SCHEDULING";
                fcfsBtn.Visible = false;
                sjfBtn.Visible = false;
                sjfPreemtiveCheck.Visible = false;
                psBtn.Visible = false;
                rrBtn.Visible = true;
                timeQuantumBox.Visible = true;
                Table.Columns.Add("Process Name", typeof(string));
                Table.Columns.Add("Arrival Time", typeof(int));
                Table.Columns.Add("Burst Time", typeof(int));
                Table.Columns.Add("Priority", typeof(int));
